...
const HUD_ROW_CLASSES =
  'flex min-h-[54px] items-center justify-between gap-4 rounded-[8px] border border-[#d9b453]/18 bg-[rgba(6,20,9,0.88)] px-3 py-2.5 shadow-[inset_0_1px_0_rgba(255,236,173,0.06)]';
...
export const SlotPaytableHUD = () => (
  ...
  >
    <div className="overflow-hidden rounded-[10px] border border-[#d9b453]/45 bg-[linear-gradient(180deg,rgba(24,43,19,0.98)_0%,rgba(8,20,10,0.98)_100%)] p-4 shadow-[0_0_0_1px_rgba(40,64,25,0.6),8px_8px_0_rgba(0,0,0,0.25)]">
      <div className="mb-4 flex items-center gap-2">
        <span className="font-mono text-[8px] uppercase tracking-[0.24em] text-[#f2d680]">
          Paytable
        </span>
        ...
        {SLOT_PAYTABLE_ENTRIES.map(({ id, prize, symbols }) => {
          ...
          return (
            ...
            >
                ...
                {isRepeatedSet ? (
                  <>
                    <img
                      alt=""
                      aria-hidden="true"
                      className="block h-[28px] w-auto max-w-none shrink-0 select-none"
                      draggable={false}
                      src={symbolSource}
                      style={{
                    ...
                    />
                    <span className="font-mono text-[9px] text-[#f2d680]">
                      x{count}
                    </span>
                  </>
                ) : (
              ...
              <span className="pl-3 font-mono text-[9px] leading-[1.45] text-right text-[#fff2c0]">
                {prize}
              </span>
            </div>
          );
